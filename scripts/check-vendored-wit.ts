...
const AUTHORITY = "node_modules/@libre-ai/contracts-authority/contracts/wit/policy-core-v1";
const VENDORED = "vendored/wit/policy-core-v1";
const write = process.argv.includes("--write");

const source = readdirSync(AUTHORITY)
  .filter((name) => name.endsWith(".wit"))
  .sort();
